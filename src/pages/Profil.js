...
const Profil = () => {
    ...
    const [nomorTelepon, setNomorTelepon ] = useState(localStorage.getItem("nomorTelepon"));
            ...
            <main>
                <div className="container-fluid">
                    ...
                    <div className="container section-main">
                        <div className='kiri'>
                            <img src={profilFinal.length ? profilFinal : img} className='gambar-profil' onClick={()=> setImageCrop(true)}/>
                            <h4>{nama}</h4>
                        ...
                        <div className='kanan'>
                            ...
                            <div className='section-button'>
                                <a className="mx-3 btn btn-primary" type="button" data-bs-toggle="modal" data-bs-target="#modal" id="edit">Edit Data</a> 
                            </div>
                            ...
                            <div class="modal fade" id="modal" aria-hidden="true" aria-labelledby="modal" tabindex="-1">
                                <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                                    ...
                                    <div class="modal-header">
                                        <h1 class=" modal-title " id="modal">Modal 1</h1>
                                    ...
                                    <div class="modal-body">
                                        <form onSubmit={handleSubmit}>
                                            ...
                                            <input type="text" className="form-control" id="tinggi" name="tinggi" 
                                                 value={tinggi} onChange={(e)=> setTinggi(e.target.value
                                                    )} />
                    ...
                    <Dialog 
                            visible={imageCrop}
                            header={()=>(
                                <p htmlFor="" className='text-2xl font-semibold textcolor'>Unggah Foto Profil</p>
                            )}
